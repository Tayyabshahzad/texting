...
CREATE TABLE `twilio_sms_log` (
  ...
  `sms_sid` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sms_message_sid` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `event` enum('send_sms_request','send_sms_request_error','message_received','segment_status_changed','status_changed','invalid_request_sid_not_defined','twilio_sms_not_found','generic_error','not_categorized') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_categorized',
...
-- Dump completed on 2023-03-30  0:34:04
